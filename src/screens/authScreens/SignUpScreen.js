...
export default function SignUpScreen({navigation}) {
    ...
    const[passwordFocussed, setPasswordFocussed] = useState(true)
    ...
    return(
        <View style = {styles.container}>
           <Header title ="MY ACCOUNT"  type ="arrow-left" navigation ={navigation} title = "Create New Account"/> 
           <ScrollView keyboardShouldPersistTaps = "always">
                            ...
                            <View>
                               ...
                               <View style ={styles.view14}>
                                    <View>
                                            ...
                                            <Icon name ="lock" color ={COLORs.grey3}  type = "material" style = {styles.email}/>
                                            </Animatable.View>
                                    </View>
                                    <TextInput 
                                        ...
                                        onFocus = {()=>{setPasswordFocussed(false)}}
                                        onBlur = {()=>{setPasswordBlured(true)}}
                                    />
                                    <View>
                                        <Animatable.View  animation = {passwordFocussed?"fadeInLeft":"fadeInRight"} duration ={400}>
                                            <Icon name ="visibility-off" color ={COLORs.grey3}  type = "material" style ={styles.visibilityOff}/>
                                        </Animatable.View> 
                                    </View>
                               </View>
                ...
                <View style ={styles.view19}>
                    <View style ={styles.view20}>
                        <Text style = {{marginLeft: 5}}>Already have an account with XpressFood ?</Text>
                    </View>
